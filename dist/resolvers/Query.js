...
const Query = {
  ...
  internalTxByAddress(parent, args, ctx, info) {
    ...
    const apiCall = fetch(`http://api.etherscan.io/api?module=account&action=txlistinternal&address=${account}&startblock=${startblock}&endblock=${endblock}&sort=${order}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
  ...
  internalTxByHash(parent, args, ctx, info) {
    ...
    const apiCall = fetch(`https://api.etherscan.io/api?module=account&action=txlistinternal&txhash=${hash}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
  ...
  ERC20TransferEventsByAddress(parent, args, ctx, info) {
    ...
    const apiCall = fetch(`http://api.etherscan.io/api?module=account&action=tokentx&address=${account}&startblock=${startblock}&endblock=${endblock}&sort=${order}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  blocksMinedByAddress(parent, args, ctx, info) {
    const { account } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=account&action=getminedblocks&address=${account}&blocktype=blocks&apikey=YourApiKeyToken${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  ////////////////////////
  //      Contracts     //
  ...
  getContractABI(parent, args, ctx, info) {
    const { contract } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=contract&action=getabi&address=${contract}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  getContractSourceCode(parent, args, ctx, info) {
    const { contract } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=contract&action=getsourcecode&address=${contract}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  ////////////////////////
  //    Transactions    //
  ...
  checkContractExecutionStatus(parent, args, ctx, info) {
    const { txhash } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=transaction&action=getstatus&txhash=${txhash}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  checkTransactionReceiptStatus(parent, args, ctx, info) {
    const { txhash } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=transaction&action=gettxreceiptstatus&txhash=${txhash}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  ////////////////////////
  //       Blocks       //
  ...
  getBlockAndUncleRewardsByBlockNo(parent, args, ctx, info) {
    ...
    const { blockNo } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=block&action=getblockreward&blockno=${blockNo}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  ////////////////////////
  //    Event Logs      //
  ...
  eth_BlockNumber(parent, args, ctx, info) {
    ...
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_blockNumber&apikey=${apiKey}`).then(res => res.json().then(data => data));
    return apiCall;
  },
  eth_getBlockByNumber(parent, args, ctx, info) {
    //Returns information about a block by block number.
    const { blockNo } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getBlockByNumber&tag=${blockNo}&boolean=true&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  ...
  eth_getUncleByBlockNumberAndIndex(parent, args, ctx, info) {
    ...
    const { blockNo } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getUncleByBlockNumberAndIndex&tag=${blockNo}&index=0x0&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getBlockTransactionCountByNumber(parent, args, ctx, info) {
    // Returns the number of transactions in a block from a block matching the given block number
    const { blockNo } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getBlockTransactionCountByNumber&tag=${blockNo}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getTransactionByHash(parent, args, ctx, info) {
    // Returns the information about a transaction requested by transaction hash
    const { hash } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getTransactionByHash&txhash=${hash}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getTransactionByBlockNumberAndIndex(parent, args, ctx, info) {
    // Returns information about a transaction by block number and transaction index position
    const { blockNo } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getTransactionByBlockNumberAndIndex&tag=${blockNo}&index=0x0&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getTransactionCount(parent, args, ctx, info) {
    // Returns the number of transactions sent from an address
    const { account } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getTransactionCount&address=${account}&tag=latest&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  // Not Supported Now
  ...
  eth_getTransactionReceipt(parent, args, ctx, info) {
    ...
    const { txHash } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getTransactionReceipt&txhash=${txHash}&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_call(parent, args, ctx, info) {
    //Executes a new message call immediately without creating a transaction on the block chain
    const { address, data } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_call&to=${address}&data=${data}&tag=latest&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getCode(parent, args, ctx, info) {
    //Returns code at a given address
    const { address } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getCode&address=${address}&tag=latest&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_getStorageAt(parent, args, ctx, info) {
    // Returns the value from a storage position at a given address. (**experimental)
    const { address } = args;
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_getStorageAt&address=${address}&position=0x0&tag=latest&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  eth_gasPrice(parent, args, ctx, info) {
    // Returns the current price per gas in wei.
    const apiCall = fetch(`https://api.etherscan.io/api?module=proxy&action=eth_gasPrice&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  // Not supported now
  ...
  getTotalSupplyOfEther(parent, args, ctx, info) {
    ...
    const apiCall = fetch(`https://api.etherscan.io/api?module=stats&action=ethsupply&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  },
  getEtherLastPrice(parent, args, ctx, info) {
    // Get ETHER LastPrice Price
    const apiCall = fetch(`https://api.etherscan.io/api?module=stats&action=ethprice&apikey=${apiKey}`).then(res => res.json().then(data => data.result));
    return apiCall;
  }
};
